...
public class ReservationDaoSqls {
    ...
    public static final String SELECT_BY_USER_EMAIL = "SELECT r.id, r.product_id, r.display_info_id, r.cancel_flag, " +
            "p.description AS product_description, p.content AS product_content, u.id AS user_id, rp.count * pp.price AS sum_price, " +
            "r.reservation_date, r.create_date, r.modify_date FROM user AS u, reservation_info AS r, " +
            ...
            "u.id = r.user_id AND u.email = :email";
    public static final String DELETE_BY_ID = "DELETE FROM reservation_info WHERE id = :id";
    public static final String CANCEL_BY_ID = "UPDATE reservation_info SET cancel_flag = 1 WHERE id = :id and user_id = :userId";
}
